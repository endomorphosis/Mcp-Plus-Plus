...
This folder is the canonical documentation set for the MCP++ project.

## Start Here (for humans and AI agents)

- Agent onboarding: [agents/start-here.md](agents/start-here.md)
- Architecture overview: [architecture/overview.md](architecture/overview.md)
- Glossary (including archive aliases): [architecture/glossary.md](architecture/glossary.md)
- Archive → canonical traceability checklist: [architecture/traceability.md](architecture/traceability.md)
