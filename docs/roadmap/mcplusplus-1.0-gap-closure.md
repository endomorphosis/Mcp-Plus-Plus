...
| REQ-DUR-01 | `DurableExecutor` interface + crash recovery without duplicate effects | plan KD-12, gates 17 | **missing** | — | — | duplicate side effects after crash | DuckDB/Quack journaled adapter (SQLite fallback) | crash-recovery tests | `missing` | plan G090 | MCPP-050…053 |
